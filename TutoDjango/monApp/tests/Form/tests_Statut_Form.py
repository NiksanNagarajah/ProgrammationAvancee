...
class StatutFormTest(TestCase):
    ...
    def test_form_valid_data_too_long(self):
        ...
        'StatutPourTestStatutPourTestStatutPourTestStatutPourTestStatutPourTestStatutPourTestStatutPourTestStatutPourTest'})
        ...
        self.assertEqual(form.errors['libelleStatus'], ['Assurez-vous que cette valeur comporte au plus 100 caractères (actuellement 112).'])
